<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Add News source</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form"  data-toggle="validator"  method="POST" action="<?php echo site_url(); ?>/news_source/insert_source">


                                <div class="form-group">
                                    <label><span style="color: red;">*</span>Source Title</label>
                                    <input class="form-control need"  type="text" name="source[name]" label="Source Title" required>

                                </div>
                                <div class="form-group">
                                    <label><span style="color: red;">*</span>Source sort name</label>
                                    <input class="form-control need"  type="text" name="source[short_name]" label="Source sort name" required>
