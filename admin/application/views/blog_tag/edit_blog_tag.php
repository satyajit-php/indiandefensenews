        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Blog Tag</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="blog_frm" name="blog_frm" method="POST" action="<?php echo base_url();?>index.php/blog_tag/update_blog" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control need" id="blog" name="blog" label="Tag Name" value="<?php echo $blog_data[0]->tag_name;?>">
