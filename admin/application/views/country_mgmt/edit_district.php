  <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit District</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="country_frm" name="country_frm" method="POST" action="<?php echo base_url();?>index.php/country_cont/update_district" enctype="multipart/form-data">
                                      ...
                                      <?php
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>District Name
                                            <span style="color: red;">*</span>:</label>
                                            <input class="form-control need" id="district" name="district" label="District Name" value="<?php  echo $district ;?>">
