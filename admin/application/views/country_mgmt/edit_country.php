                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="country_frm" name="country_frm" method="POST" action="<?php echo base_url();?>index.php/country_cont/update_country/<?php echo $country_arr[0]->id;?>" enctype="multipart/form-data">
                                        
                                        <div class="form-group">
                                            <label>Country Name
                                            <span style="color: red;">*</span>:</label>
                                            <input class="form-control need" id="country_name" name="country_name" label="Country Name" value="<?php echo $country_arr[0]->country_name;?>">
                                            <span id="country_name_error" style="color: red;"></span>
                                        </div>
                                        <div class="form-group">
                                            <label>Currency
                                            <span style="color: red;">*</span>:</label>
                                            <input class="form-control need" id="currency" name="currency" label="Currency" value="<?php echo $country_arr[0]->currency_name;?>">
                                            <span id="currency_error" style="color: red;"></span>
                                        </div>
                                        <div class="form-group">
                                            <label>Currency Code
                                            <span style="color: red;">*</span>:</label>
                                            <input class="form-control need" id="currency_code" name="currency_code" label="Currency Code" value="<?php echo $country_arr[0]->currency_name;?>">
                                            <span id="currency_code_error" style="color: red;"></span>
                                        </div>
                                        <div class="form-group">
                                            <label>Symbol
                                            <span style="color: red;">*</span>:</label>
                                            <input class="form-control need" id="symbol" name="symbol" label="Symbol" value="<?php echo $country_arr[0]->symbol;?>">
                                            <span id="symbol_error" style="color: red;"></span>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Status<span style="color: red;">*</span>:</label>
                                            <select class="form-control" id="country_stat" name="country_stat">
                                            <option value="0" <?php if($country_arr[0]->status=='0'){?> selected="selected" <?php } ?>>Active</option>
                                            <option value="1" <?php if($country_arr[0]->status=='1'){?> selected="selected" <?php } ?>>Inactive</option>
                                            </select>
                                        </div>
